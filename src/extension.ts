...
export function activate(context: vscode.ExtensionContext) {
	...
	const CanvasObject11 : JBSObjects = {props: [...d2dCanvasObject(), ["CreateEffect", vscode.CompletionItemKind.Method], ["Present", vscode.CompletionItemKind.Method], ["SetTarget", vscode.CompletionItemKind.Method]]};
...
//`...`.match(/".+"/g).join(" ").replaceAll(/".+?"/g, "[$&], ")
    ...
    const createCanvasSpecial:Array<[string, string, JBSObjects]> = [
        ...
        ["d2d", "ID2D1DeviceContextDComposition", CanvasObject11],
        ["gl", "", GLObject],
    ];
