...
function defaultTextFormatObject() {
...
function d2dCanvasObject11DComp() {
...
function d2dSimplifiedGeometrySink() {
...
registerOARFAS("RECT", ["GetWindowRect", "GetClientRect", "GetBounds", "GetWidenedBounds", "Shell_NotifyIconGetRect", "InfiniteRect", "GetRect", "RectF"], //infinite rect listed here because although it returns an object with floats as left,top,right,bottom i don't specify allat with the extension
...
registerOARFAS("RAWINPUTDEVICE", ["MakeRAWINPUTDEVICE"], (args) => [["usUsagePage"], ["usUsage"], ["dwFlags"], ["hwndTarget"]], {});
registerOARFAS("WNDCLASSEXW", ["CreateWindowClass"], (args) => [["loop", vscode.CompletionItemKind.Method], ["windowProc", vscode.CompletionItemKind.Method], ["init", vscode.CompletionItemKind.Method], ["hbrBackground"], ["hCursor"], ["hIcon"], ["hIconSm"], ["hInstance"], ["lpszClassName"], ["lpszMenuName"], ["style"], ["DefWindowProc"]], {});
registerOARFAS("DOCINFO", ["DOCINFO"], (args) => [["lpszDocName"], ["lpszOutput"], ["lpszDatatype"], ["fwType"]], {});
registerOARFAS("STARTUPINFO", ["STARTUPINFO"], (args) => [["lpDesktop"], ["lpTitle"], ["dwX"], ["dwY"], ["dwXSize"], ["dwYSize"], ["dwXCountChars"], ["dwYCountChars"], ["dwFillAttribute"], ["dwFlags"], ["wShowWindow"], ["hStdInput"], ["hStdOutput"], ["hStdError"],], {});
registerOARFAS("PROCESS_INFORMATION", ["CreateProcess"], (args) => [["hProcess"], ["hThread"], ["dwProcessId"], ["dwThreadId"]], {});
registerOARFAS("IDXGIDebug1", ["DXGIGetDebugInterface1"], (args) => [["ReportLiveObjects", vscode.CompletionItemKind.Method]], extendMethods("IUnknown", {
...
registerOARFAS("MODULEENTRY32", ["Module32First"], (args) => [["th32ModuleID"], ["th32ProcessID"], ["GlblcntUsage"], ["ProccntUsage"], ["modBaseAddr"], ["modBaseSize"], ["hModule"], ["szModule"], ["szExePath"],], {});
registerOARFAS("Canvas", ["createCanvas"], (args) => {
    let arr = []; //d2dCanvasObject();
    ...
    "CreateBitmapFromDxgiSurface": makeArgs("function CreateBitmapFromDxgiSurface(bitmapOptions : D2D1_BITMAP_OPTIONS, format? : DXGI_FORMAT, alphaMode? : D2D1_ALPHA_MODE) : Bitmap", "creates a bitmap the size of the render target or something like that  \n`bitmapOptions` are any `D2D1_BITMAP_OPTIONS`... const  \n`format` is any `DXGI_FORMAT`... const (but usually `DXGI_FORMAT_B8G8R8A8_UNORM`)  \n`alphaMode` is any `D2D1_ALPHA_MODE`... const (usually `D2D1_ALPHA_MODE_PREMULTIPLIED`)"),
    "CreateBitmap1": makeArgs("function CreateBitmap1(width : number, height : number, bitmapOptions : D2D1_BITMAP_OPTIONS, format? : DXGI_FORMAT, alphaMode? : D2D1_ALPHA_MODE, bits? : Uint8Array, pitch? : number) : Bitmap", "creates a special bitmap with the specified `width` and `height`  \n`bitmapOptions` are any `D2D1_BITMAP_OPTIONS`... const  \n`format` is any `DXGI_FORMAT`... const (but usually `DXGI_FORMAT_B8G8R8A8_UNORM`)  \n`alphaMode` is any `D2D1_ALPHA_MODE`... const (usually `D2D1_ALPHA_MODE_PREMULTIPLIED`)  \n[`pitch`](https://learn.microsoft.com/en-us/windows/win32/medfound/image-stride) is the amount of bytes in a row of pixel data (including padding)"),
...
registerOARFAS("ID2D1Effect", ["CreateEffect"], (args) => [...emptyCOMObject(), ["SetValue", vscode.CompletionItemKind.Method], ["SetInput", vscode.CompletionItemKind.Method], ["SetInputEffect", vscode.CompletionItemKind.Method]], extendMethods("IUnknown", {
...
registerOARFAS("IDCompositionFilterEffect", [], (args) => d2dCompositionEffect(), extendMethods("IUnknown", {
...
registerOARFAS("IDCompositionGaussianBlurEffect", ["CreateGaussianBlurEffect"], (args) => [...d2dCompositionEffect(), ["SetStandardDeviation", vscode.CompletionItemKind.Method], ["SetBorderMode", vscode.CompletionItemKind.Method]], extendMethods("IDCompositionFilterEffect", {
...
registerOARFAS("IDCompositionBrightnessEffect", ["CreateBrightnessEffect"], (args) => [...d2dCompositionEffect(), ["SetWhitePoint", vscode.CompletionItemKind.Method], ["SetBlackPoint", vscode.CompletionItemKind.Method]], extendMethods("IDCompositionFilterEffect", {
...
registerOARFAS("IDCompositionColorMatrixEffect", ["CreateColorMatrixEffect"], (args) => [...d2dCompositionEffect(), ["SetMatrix", vscode.CompletionItemKind.Method], ["SetMatrixElement", vscode.CompletionItemKind.Method], ["SetAlphaMode", vscode.CompletionItemKind.Method], ["SetClampOutput", vscode.CompletionItemKind.Method],], extendMethods("IDCompositionFilterEffect", {
...
registerOARFAS("IDCompositionShadowEffect", ["CreateShadowEffect"], (args) => [...d2dCompositionEffect(), ["SetStandardDeviation", vscode.CompletionItemKind.Method], ["SetColor", vscode.CompletionItemKind.Method]], extendMethods("IDCompositionFilterEffect", {
...
registerOARFAS("IDCompositionHueRotationEffect", ["CreateHueRotationEffect"], (args) => [...d2dCompositionEffect(), ["SetAngle", vscode.CompletionItemKind.Method]], extendMethods("IDCompositionFilterEffect", {
    "SetAngle": makeArgs("function SetAngle(angle : number) : void", "Sets the angle to rotate the hue."),
}));
registerOARFAS("IDCompositionSaturationEffect", ["CreateSaturationEffect"], (args) => [...d2dCompositionEffect(), ["SetSaturation", vscode.CompletionItemKind.Method]], extendMethods("IDCompositionFilterEffect", {
    "SetSaturation": makeArgs("function SetSaturation(angle : number) : void", "Sets the saturation of the image."),
}));
registerOARFAS("IDCompositionTurbulenceEffect", ["CreateTurbulenceEffect"], (args) => [...d2dCompositionEffect(), ["SetOffset", vscode.CompletionItemKind.Method], ["SetBaseFrequency", vscode.CompletionItemKind.Method], ["SetSize", vscode.CompletionItemKind.Method], ["SetNumOctaves", vscode.CompletionItemKind.Method], ["SetSeed", vscode.CompletionItemKind.Method], ["SetNoise", vscode.CompletionItemKind.Method], ["SetStitchable", vscode.CompletionItemKind.Method],], extendMethods("IDCompositionFilterEffect", {
...
registerOARFAS("IDCompositionCompositeEffect", ["CreateCompositeEffect"], (args) => [...d2dCompositionEffect(), ["SetMode", vscode.CompletionItemKind.Method]], extendMethods("IDCompositionFilterEffect", {
    "SetMode": makeArgs("function SetMode(mode : D2D1_COMPOSITE_MODE | number) : void", "`mode` is a `D2D1_COMPOSITE_MODE_`... const"),
}));
registerOARFAS("IDCompositionBlendEffect", ["CreateBlendEffect"], (args) => [...d2dCompositionEffect(), ["SetMode", vscode.CompletionItemKind.Method]], extendMethods("IDCompositionFilterEffect", {
    "SetMode": makeArgs("function SetMode(mode : D2D1_BLEND_MODE | number) : void", "`mode` is a `D2D1_BLEND_MODE_`... const"),
}));
registerOARFAS("IDCompositionArithmeticCompositeEffect", ["CreateArithmeticCompositeEffect"], (args) => [...d2dCompositionEffect(), ["SetCoefficients", vscode.CompletionItemKind.Method], ["SetClampOutput", vscode.CompletionItemKind.Method]], extendMethods("IDCompositionFilterEffect", {
...
registerOARFAS("IDCompositionAffineTransform2DEffect", ["CreateAffineTransform2DEffect"], (args) => [...d2dCompositionEffect(), ["SetInterpolationMode", vscode.CompletionItemKind.Method], ["SetBorderMode", vscode.CompletionItemKind.Method], ["SetTransformMatrix", vscode.CompletionItemKind.Method], ["SetTransformMatrixElement", vscode.CompletionItemKind.Method], ["SetSharpness", vscode.CompletionItemKind.Method],], extendMethods("IDCompositionFilterEffect", {
...
registerOARFAS("ID2D1Geometry::ComputePointAtLength", ["ComputePointAtLength"], (args) => [["point"], ["unitTangentVector"]], {});
registerOARFAS("ID2D1Geometry", [], (args) => d2dGeometryObject(), extendMethods("IUnknown", {
...
registerOARFAS("ID2D1PathGeometry1", ["CreatePathGeometry"], (args) => [...d2dGeometryObject(), ["Open", vscode.CompletionItemKind.Method], ["Stream", vscode.CompletionItemKind.Method], ["GetSegmentCount", vscode.CompletionItemKind.Method], ["GetFigureCount", vscode.CompletionItemKind.Method],], extendMethods("ID2D1Geometry", {
...
registerOARFAS("ID2D1TransformedGeometry", ["CreateTransformedGeometry"], (args) => [...d2dGeometryObject(), ["GetTransform", vscode.CompletionItemKind.Method], ["GetSourceGeometry", vscode.CompletionItemKind.Method]], extendMethods("ID2D1Geometry", {
    "GetTransform": makeArgs("function GetTransform(void) : D2D1_MATRIX_3X2_F", "gets the matrix object"),
...
registerOARFAS("ID2D1RectangleGeometry", ["CreateRectangleGeometry"], (args) => [...d2dGeometryObject(), ["GetRect", vscode.CompletionItemKind.Method]], extendMethods("ID2D1Geometry", {
    "GetRect": makeArgs("function GetRect(void) : D2D1_RECT_F", "returns an object with {left, top, right, bottom} properties"),
}));
registerOARFAS("ID2D1RoundedRectangleGeometry", ["CreateRoundedRectangleGeometry"], (args) => [...d2dGeometryObject(), ["GetRoundedRect", vscode.CompletionItemKind.Method]], extendMethods("ID2D1Geometry", {
...
registerOARFAS("ID2D1EllipseGeometry", ["CreateEllipseGeometry"], (args) => [...d2dGeometryObject(), ["GetEllipse", vscode.CompletionItemKind.Method]], extendMethods("ID2D1Geometry", {
    "GetEllipse": makeArgs("function GetEllipse(void) : D2D1_ELLIPSE", "returns an object with {point, radiusX, radiusY} properties"),
}));
registerOARFAS("ID2D1SimplifiedGeometrySink", [], (args) => [...emptyCOMObject(), ["SetFillMode", vscode.CompletionItemKind.Method], ["SetSegmentFlags", vscode.CompletionItemKind.Method], ["BeginFigure", vscode.CompletionItemKind.Method], ["AddLines", vscode.CompletionItemKind.Method], ["AddBeziers", vscode.CompletionItemKind.Method], ["EndFigure", vscode.CompletionItemKind.Method], ["Close", vscode.CompletionItemKind.Method],], extendMethods("IUnknown", {
...
registerOARFAS("ID2D1GeometrySink", ["Open"], (args) => [...d2dSimplifiedGeometrySink(), ["AddLine", vscode.CompletionItemKind.Method], ["AddBezier", vscode.CompletionItemKind.Method], ["AddQuadraticBezier", vscode.CompletionItemKind.Method], ["AddQuadraticBeziers", vscode.CompletionItemKind.Method], ["AddArc", vscode.CompletionItemKind.Method],], extendMethods("ID2D1SimplifiedGeometrySink", {
...
registerOARFAS("CURSORINFO", ["GetCursorInfo"], (args) => [["flags"], ["hCursor"], ["ptScreenPos"]], {});
/*
...
*/
registerOARFAS("ID2D1Brush", [], (args) => defaultBrushObject(), extendMethods("IUnknown", {
    "SetOpacity": makeArgs("function SetOpacity(opacity : float) : void", "sets the opacity of the brush"),
    "GetOpacity": makeArgs("function GetOpacity(void) : float", "gets the opacity of the brush"),
    "GetTransform": makeArgs("function GetTransform(void) : Matrix3x2F", "gets the matrix object"),
    "SetTransform": makeArgs("function SetTransform(matrix : Matrix3x2F) : void", "sets the transform of this brush  \n`matrix` can be one gained from `GetTransform` or most `Matrix3x2F...` functions"),
}));
registerOARFAS("ID2D1SolidColorBrush", ["CreateSolidColorBrush"], (args) => [...defaultBrushObject(), ["SetColor", vscode.CompletionItemKind.Method], ["GetColor", vscode.CompletionItemKind.Method]], extendMethods("ID2D1Brush", {
...
registerOARFAS("ID2D1LinearGradientBrush", ["CreateLinearGradientBrush"], (args) => [...defaultBrushObject(), ["GetStartPoint", vscode.CompletionItemKind.Method], ["GetEndPoint", vscode.CompletionItemKind.Method], ["SetStartPoint", vscode.CompletionItemKind.Method], ["SetEndPoint", vscode.CompletionItemKind.Method], ["SetPoints", vscode.CompletionItemKind.Method]], extendMethods("ID2D1Brush", {
...
registerOARFAS("ID2D1RadialGradientBrush", ["CreateRadialGradientBrush"], (args) => [...defaultBrushObject(), ["GetCenter", vscode.CompletionItemKind.Method], ["GetGradientOriginOffset", vscode.CompletionItemKind.Method], ["GetRadiusX", vscode.CompletionItemKind.Method], ["GetRadiusY", vscode.CompletionItemKind.Method], ["GetRadius", vscode.CompletionItemKind.Method], ["SetCenter", vscode.CompletionItemKind.Method], ["SetGradientOriginOffset", vscode.CompletionItemKind.Method], ["SetRadiusX", vscode.CompletionItemKind.Method], ["SetRadiusY", vscode.CompletionItemKind.Method], ["SetRadius", vscode.CompletionItemKind.Method]], extendMethods("ID2D1Brush", {
...
registerOARFAS("IDWriteTextFormat", [], (args) => defaultTextFormatObject(), extendMethods("IUnknown", {
    //return [["internalPtr"], ["Release", vscode.CompletionItemKind.Method], /*["family"],*/ ["GetFontSize", vscode.CompletionItemKind.Method], ["GetFlowDirection", vscode.CompletionItemKind.Method], ["GetFontFamilyName", vscode.CompletionItemKind.Method], ["GetFontFamilyNameLength", vscode.CompletionItemKind.Method], ["GetFontStretch", vscode.CompletionItemKind.Method], ["GetFontStyle", vscode.CompletionItemKind.Method] ,["GetFontWeight", vscode.CompletionItemKind.Method] ,["GetIncrementalTabStop", vscode.CompletionItemKind.Method], ["GetLineSpacing", vscode.CompletionItemKind.Method], ["GetParagraphAlignment", vscode.CompletionItemKind.Method], ["GetReadingDirection", vscode.CompletionItemKind.Method], ["GetTextAlignment", vscode.CompletionItemKind.Method], ["GetWordWrapping", vscode.CompletionItemKind.Method], ["GetTrimming", vscode.CompletionItemKind.Method], ["SetFlowDirection", vscode.CompletionItemKind.Method], ["SetIncrementalTabStop", vscode.CompletionItemKind.Method], ["SetLineSpacing", vscode.CompletionItemKind.Method], ["SetParagraphAlignment", vscode.CompletionItemKind.Method], ["SetReadingDirection", vscode.CompletionItemKind.Method],["SetTextAlignment", vscode.CompletionItemKind.Method],["SetTrimming", vscode.CompletionItemKind.Method],["SetWordWrapping", vscode.CompletionItemKind.Method],["SetFontSize", vscode.CompletionItemKind.Method]];
...
registerOARFAS("ID2D1Bitmap", ["CreateBitmap", "CreateBitmapFromWicBitmap", "CreateBitmapFromFilename", "GetBitmap"], (args) => [...emptyCOMObject(), ["GetDpi", vscode.CompletionItemKind.Method], ["GetPixelFormat", vscode.CompletionItemKind.Method], ["GetPixelSize", vscode.CompletionItemKind.Method], ["GetSize", vscode.CompletionItemKind.Method], ["CopyFromBitmap", vscode.CompletionItemKind.Method], ["CopyFromRenderTarget", vscode.CompletionItemKind.Method], ["CopyFromMemory", vscode.CompletionItemKind.Method]], extendMethods("IUnknown", {
...
registerOARFAS("ID2D1ImageBrush", ["CreateImageBrush"], (args) => [...defaultBrushObject(), ["GetExtendModeX", vscode.CompletionItemKind.Method], ["GetExtendModeY", vscode.CompletionItemKind.Method], ["GetExtendMode", vscode.CompletionItemKind.Method], ["GetInterpolationMode", vscode.CompletionItemKind.Method], ["SetExtendModeX", vscode.CompletionItemKind.Method], ["SetExtendModeY", vscode.CompletionItemKind.Method], ["SetExtendMode", vscode.CompletionItemKind.Method], ["SetInterpolationMode", vscode.CompletionItemKind.Method], ["SetImage", vscode.CompletionItemKind.Method], ["GetImage", vscode.CompletionItemKind.Method]], extendMethods("ID2D1Brush", {
    "GetExtendModeX": makeArgs("function GetExtendModeX(void) : D2D1_EXTEND_MODE | number", "Gets the method by which the brush horizontally tiles those areas that extend past its bitmap.  \nreturns a `D2D1_EXTEND_MODE_`... const for x"),
    "GetExtendModeY": makeArgs("function GetExtendModeY(void) : D2D1_EXTEND_MODE | number", "Gets the method by which the brush vertically tiles those areas that extend past its bitmap.  \nreturns a `D2D1_EXTEND_MODE_`... const for y"),
    "GetExtendMode": makeArgs("function GetExtendMode(void) : {x : D2D1_EXTEND_MODE | number, y : D2D1_EXTEND_MODE | number}", "helper function to get the x and y extend modes (they're both a `D2D1_EXTEND_MODE_`... const)"),
    "GetInterpolationMode": makeArgs("function GetInterpolationMode(void) : D2D1_BITMAP_INTERPOLATION_MODE", "Gets the interpolation method used when the brush bitmap is scaled or rotated.  \nreturns a `D2D1_BITMAP_INTERPOLATION_MODE_`... const"),
...
registerOARFAS("IWICImagingFactory2", ["InitializeWIC"], (args) => [...emptyCOMObject(), ["LoadBitmapFromFilename", vscode.CompletionItemKind.Method], ["LoadDecoder", vscode.CompletionItemKind.Method], ["ConvertBitmapSource", vscode.CompletionItemKind.Method], ["CreateBitmapFromHBITMAP", vscode.CompletionItemKind.Method], ["CreateBitmapFromHICON", vscode.CompletionItemKind.Method], ["LoadBitmapFromBinaryData", vscode.CompletionItemKind.Method], ["SaveBitmapToFilename", vscode.CompletionItemKind.Method]], extendMethods("IUnknown", {
    "LoadBitmapFromFilename": makeArgs("function LoadBitmapFromFilename(filename : wstring | string, format : GUID, frameNumber? : number) : wicConverter*", "format can be any `GUID_`... const (you must use `ScopeGUIDs` before accessing any `GUID_`... const)  \nreturns a wicConverter object for use with d2d.`CreateBitmapFromWicBitmap`"),
...
registerOARFAS("IWICBitmapSource", ["LoadBitmapFromFilename", "GetThumbnail", "GetPreview", "GetBitmapFrame"], (args) => [...emptyCOMObject(), ["GetPixels", vscode.CompletionItemKind.Method], ["GetResolution", vscode.CompletionItemKind.Method], ["GetSize", vscode.CompletionItemKind.Method], ["GUID"], ["GetPixelFormat", vscode.CompletionItemKind.Method], ["Resize", vscode.CompletionItemKind.Method]], extendMethods("IUnknown", {
    "GetPixels": makeArgs("function GetPixels(wic : any, transformOption? : WICBitmapTransformOptions) : Uint32Array", "returns a large Uint32Array (for use with `StretchDIBits` or `CreateBitmap`)  \n`wic` is an object created with `InitializeWIC`  \ntransformOption is any `WICBitmapTransform`... const"),
...
registerOARFAS("IWICBitmapDecoder", ["LoadDecoder"], (args) => [...emptyCOMObject(), ["GetFrameCount", vscode.CompletionItemKind.Method], ["GetBitmapFrame", vscode.CompletionItemKind.Method], ["GetThumbnail", vscode.CompletionItemKind.Method], ["GetPreview", vscode.CompletionItemKind.Method], ["GetContainerFormat", vscode.CompletionItemKind.Method]], extendMethods("IUnknown", {
...
registerOARFAS("BITMAPINFO", ["CreateDIBitmapSimple"], (args) => [["dsBmih"]], {});
...
registerOARFAS("D2D1", [], (args) => [["ColorF", vscode.CompletionItemKind.Class], ["InfiniteRect", vscode.CompletionItemKind.Method], ["RectF", vscode.CompletionItemKind.Method], ["RoundedRect", vscode.CompletionItemKind.Method], ["Ellipse", vscode.CompletionItemKind.Method], ["LayerParameters", vscode.CompletionItemKind.Method]], {
